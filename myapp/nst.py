...
# """
# def generate_image(content_img, style_img):
#     import os
...
#     #        content_path = request.POST.get('content_path')
...
#     """
#     return g
def generate_image(content_img1, style_img1):
    import os
    import tensorflow as tf
    ...
    a = Image.open(content_img1)
    b=Image.open(style_img1)
    content_img= tf.convert_to_tensor(a, dtype=tf.float32)
    style_img= tf.convert_to_tensor(b, dtype=tf.float32)
